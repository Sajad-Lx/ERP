package com.orion.erp_back.common.exception.handler
...
class ErrorHandler {
    ...
    protected fun handleCustomRuntimeException(
        exception: CustomRuntimeException, httpServletRequest: HttpServletRequest
    ): ResponseEntity<ErrorResponse> {
        val response = ErrorResponse.of(
            HttpStatus.INTERNAL_SERVER_ERROR.value(), exception.message ?: "Internal Server Error"
        )
    ...
    protected fun handleExpiredJwtException(
        exception: ExpiredJwtException, httpServletRequest: HttpServletRequest
    ): ResponseEntity<ErrorResponse> {
        val response = ErrorResponse.of(
            HttpStatus.UNAUTHORIZED.value(), exception.message ?: "Expired JWT"
        )
    ...
    protected fun handleNotFoundException(
        exception: NotFoundException, httpServletRequest: HttpServletRequest
    ): ResponseEntity<ErrorResponse> {
        val response = ErrorResponse.of(
            HttpStatus.NOT_FOUND.value(), exception.message ?: "Not Found"
        )
    ...
    protected fun handleUnAuthorizedException(
        exception: UnAuthorizedException, httpServletRequest: HttpServletRequest
    ): ResponseEntity<ErrorResponse> {
        val response = ErrorResponse.of(
            HttpStatus.UNAUTHORIZED.value(), exception.message ?: "UnAuthorized"
        )
    ...
    protected fun handleAlreadyExistException(
        exception: AlreadyExistException, httpServletRequest: HttpServletRequest
    ): ResponseEntity<ErrorResponse> {
        val response = ErrorResponse.of(
            HttpStatus.CONFLICT.value(), exception.message ?: "Already Exist"
        )
    ...
    protected fun handleMethodArgumentNotValidException(
        exception: BindException, httpServletRequest: HttpServletRequest
    ): ResponseEntity<ErrorResponse> {
        ...
        val response = ErrorResponse.of(
            HttpStatus.BAD_REQUEST.value(), stringBuilder.toString(), exception.fieldErrors
        )
    ...
    protected fun handleAuthenticationException(
        exception: AuthenticationException, httpServletRequest: HttpServletRequest
    ): ResponseEntity<ErrorResponse> {
        val response = ErrorResponse.of(
            HttpStatus.UNAUTHORIZED.value(), exception.message ?: "Authentication Error"
        )
    ...
    protected fun handleNoHandlerFoundException(
        exception: NoHandlerFoundException, httpServletRequest: HttpServletRequest
    ): ResponseEntity<ErrorResponse> {
        val response = ErrorResponse.of(
