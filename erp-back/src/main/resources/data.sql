...
VALUES (1, 'Admin', 'Admin', '$2a$10$JSgv0UFyA6Ly7e.1lQGzmepbUSBx0vpQriE/YV2bBa6gbV/qX.0zW', 'admin.admin', false, '5TPFV3VGX3EKYAET');
-- password test1234
INSERT INTO app_user (id, first_name, last_name, password, username, isUsing2FA, secret)
VALUES (2, 'John', 'Doe', '$2a$10$JSgv0UFyA6Ly7e.1lQGzmepbUSBx0vpQriE/YV2bBa6gbV/qX.0zW', 'john.doe', true, '5TPFV3VGX3EKYAET');
